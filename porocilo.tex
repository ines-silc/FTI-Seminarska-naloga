...
\caption{Fundacije zasebnih univerz}
\label{Slika 1}
\end{figure}
...
\caption{Fundacije javnih univerz}
\label{Slika 2}
\end{figure}

Na sliki 2 pa so prikazane skupne vrednosti fundacij javnih univerz po zveznih državah ZDA. Kot vidimo, zelo jasno iztopa zvezna država Teksas, kjer prejmejo skupno kar 45.790 bilijonov \$ fundacij, precej za Teksasom pa je Kalifornija z 17.666 bilijonov \$ fundacij. Nato sledijo še Pensilvanija, Virginija in Michigan. 
